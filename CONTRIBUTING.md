...
(screenshot, video, or before/after). Cursor agents that comment as Cursor
may also leave one PR comment on what a reviewer should doubt; Claude Code
and other tools that comment as the human author must not.
