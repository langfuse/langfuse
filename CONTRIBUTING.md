...
- Canonical shared docs:
  - `.agents/AGENTS.md`
- Discovery symlinks (committed, generated by `pnpm run agents:sync`):
  - `AGENTS.md` and `CLAUDE.md` at the repo root
  - a sibling `CLAUDE.md` next to every package-local `AGENTS.md`. Write
    guidance in the `AGENTS.md`; never hand-write a `CLAUDE.md`.
