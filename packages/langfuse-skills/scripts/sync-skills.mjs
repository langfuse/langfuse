...
const generatedPath = resolve(packageRoot, "src/generated/skills.ts");
const sourceApiUrl =
...
import type { LangfuseSkill } from "../index.js";

export const LANGFUSE_SKILLS = [
${skills
  .map(
    (skill) =>
  ...
  .join("\n")}
] as const satisfies readonly LangfuseSkill[];
`,
    { parser: "typescript" },
  );
