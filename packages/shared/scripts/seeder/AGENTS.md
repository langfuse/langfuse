...
pnpm run seed -- v4-migration  # a project in the v4 upgrade panel's "action needed" state (legacy SDK majors, delayed OTel, unattributed ingestion, trace-target evaluator, legacy export)
```
