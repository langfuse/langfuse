...
export type AnnotationQueue = {
  ...
  score_config_ids: Generated<unknown>;
  project_id: string;
  created_at: Generated<Timestamp>;
  updated_at: Generated<Timestamp>;
};
...
export type Comment = {
  ...
  path: Generated<unknown>;
  range_start: Generated<unknown>;
  range_end: Generated<unknown>;
};
...
export type LlmApiKeys = {
  ...
  adapter: string;
  custom_models: Generated<unknown>;
  with_default_models: Generated<number>;
  config: unknown | null;
  extra_headers: string | null;
  extra_header_keys: Generated<unknown>;
};
...
export type Organization = {
  ...
  metadata: unknown | null;
  cloud_billing_cycle_anchor: Timestamp | null;
  ...
  ai_features_enabled: Generated<number>;
};
...
export type User = {
  ...
  v4_beta_enabled: Generated<number>;
  created_at: Generated<Timestamp>;
  updated_at: Generated<Timestamp>;
