/*
  ...
  - The values [MODEL_BASED_EVALUATION] on the enum `ScoreSource` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ScoreSource_new" AS ENUM ('API', 'REVIEW', 'EVALS');
