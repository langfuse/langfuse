...
VALUES
  ...
  -- add new model name gpt-4-turbo currently pointing to gpt-4-turbo-2024-04-09
  ...
  ('clrkvq6iq000008ju6c16gynt', NULL, ' gpt-4-preview', '(?i)^(gpt-4-turbo-preview)$',  NULL, 0.00001, 0.00003, NULL, 'TOKENS', 'openai', '{ "tokensPerMessage": 3, "tokensPerName": 1, "tokenizerModel": "gpt-4-turbo-preview" }')
