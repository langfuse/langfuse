...
const getExperimentItemScoreOptionsByLevel = async ({
  ...
  const [traceResults, obsResults] = await Promise.all([
    queryClickhouse<ScoreFilterOptionsRow>({
      ...
      tags: experimentQueryTags({
        projectId,
        query: "experiments.items.filter-options.trace-scores",
    ...
    queryClickhouse<ScoreFilterOptionsRow>({
      ...
      tags: experimentQueryTags({
        projectId,
        query: "experiments.items.filter-options.observation-scores",
        operation: "filter-options",
        table: "multiple",
      }),
      preferredClickhouseService: "ReadOnly",
...
const getExperimentScoreOptionsByLevel = async ({
  ...
  const [obsResults, runResults] = await Promise.all([
    queryClickhouse<ScoreFilterOptionsRow>({
      ...
      tags: experimentQueryTags({
        projectId,
        query: "experiments.filter-options.observation-scores",
        operation: "filter-options",
        table: "multiple",
      }),
      preferredClickhouseService: "ReadOnly",
    ...
    queryClickhouse<ScoreFilterOptionsRow>({
      ...
      tags: experimentQueryTags({
        projectId,
        query: "experiments.filter-options.run-scores",
        operation: "filter-options",
        table: "scores",
      }),
      preferredClickhouseService: "ReadOnly",
