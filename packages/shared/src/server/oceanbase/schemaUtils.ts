...
import { OceanBaseTableName, OceanBaseTableNames } from "./schema";

export const isValidTableName = (
  tableName: string,
): tableName is OceanBaseTableName =>
  Object.keys(OceanBaseTableNames).includes(tableName);
...
export const getOceanBaseEntityType = (
  eventType: string,
