...
export const tracesTableUiColumnDefinitions: UiColumnMappings = [
  ...
  },
  {
    ...
    clickhouseTableName: "observations",
    clickhouseSelect:
      "COALESCE(CAST(JSON_VALUE(o.usage_details, '$.input') AS DECIMAL), 0)",
  ...
  },
  {
    ...
    clickhouseTableName: "observations",
    clickhouseSelect:
      "COALESCE(CAST(JSON_VALUE(o.usage_details, '$.output') AS DECIMAL), 0)",
    clickhouseTypeOverwrite: "",
  },
  {
    ...
    clickhouseTableName: "observations",
    clickhouseSelect: "COALESCE(JSON_VALUE(o.usage_details, '$.total'), NULL)",
    clickhouseTypeOverwrite: "",
  },
  {
    uiTableName: "Tokens",
  ...
  },
  {
    ...
    clickhouseTableName: "observations",
    clickhouseSelect:
      "COALESCE(CAST(JSON_VALUE(o.cost_details, '$.input') AS DECIMAL), 0)",
  },
  {
    ...
    clickhouseTableName: "observations",
    clickhouseSelect:
      "COALESCE(CAST(JSON_VALUE(o.cost_details, '$.output') AS DECIMAL), 0)",
  },
  {
    ...
    clickhouseTableName: "observations",
    queryPrefix: "",
    clickhouseSelect: "JSON_VALUE(o.cost_details, '$.total')",
  },
];
