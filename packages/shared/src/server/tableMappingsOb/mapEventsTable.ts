// OceanBase/MySQL version of events table column mappings.
// Uses TIMESTAMPDIFF, IF, JSON_VALUE/JSON_LENGTH/JSON_KEYS instead of ClickHouse date_diff/map*.
...
export const eventsTableNativeUiColumnDefinitions: UiColumnMappings = [
  ...
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "IF(e.completion_start_time IS NULL, NULL, TIMESTAMPDIFF(MICROSECOND, e.start_time, e.completion_start_time) / 1000)",
  ...
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "IF(e.end_time IS NULL, NULL, TIMESTAMPDIFF(MICROSECOND, e.start_time, e.end_time) / 1000)",
    clickhouseTypeOverwrite: "Decimal64(3)",
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "IF(e.end_time IS NULL, NULL, COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(e.usage_details, '$.output')) AS DECIMAL(18,6)), 0) / NULLIF(TIMESTAMPDIFF(MICROSECOND, e.start_time, e.end_time) / 1000000, 0))",
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(e.cost_details, '$.input')) AS DECIMAL(18,12)), 0)",
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(e.cost_details, '$.output')) AS DECIMAL(18,12)), 0)",
  },
  {
    uiTableName: "Total Cost ($)",
    uiTableId: "totalCost",
    clickhouseTableName: "events_proto",
    clickhouseSelect: "JSON_UNQUOTE(JSON_EXTRACT(e.cost_details, '$.total'))",
  },
  {
    uiTableName: "Level",
    uiTableId: "level",
  ...
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(e.usage_details, '$.input')) AS DECIMAL(18,6)), 0)",
    clickhouseTypeOverwrite: "Decimal64(3)",
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect:
      "COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(e.usage_details, '$.output')) AS DECIMAL(18,6)), 0)",
    clickhouseTypeOverwrite: "Decimal64(3)",
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect: "JSON_UNQUOTE(JSON_EXTRACT(e.usage_details, '$.total'))",
    clickhouseTypeOverwrite: "Decimal64(3)",
  },
  {
    uiTableName: "Tokens",
  ...
  },
  {
    ...
    clickhouseTableName: "events_proto",
    clickhouseSelect: "JSON_LENGTH(e.tool_definitions)",
  },
  {
    uiTableName: "Tool Calls",
    uiTableId: "toolCalls",
    clickhouseTableName: "events_proto",
    clickhouseSelect: "JSON_LENGTH(e.tool_calls)",
  },
  {
    uiTableName: "Tool Names",
    uiTableId: "toolNames",
    clickhouseTableName: "events_proto",
    clickhouseSelect: "JSON_KEYS(e.tool_definitions)",
  },
  {
