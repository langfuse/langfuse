      ...
      messages: expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          parts: expect.arrayContaining([
            expect.objectContaining({
              type: "tool-result",
              // Existing fallback: result uses the name, but its call has no ID.
              // This characterizes current behavior, not reliable correlation.
              toolCallId: "say_hello",
              output: { greeting: "Hello Langfuse 👋" },
            }),
          ]),
        }),
        expect.objectContaining({
