...
export const SKILL_LATEST_LABEL = "latest";
export const SKILL_PRODUCTION_LABEL = "production";
...
export const SkillFileWithDownloadSchema = SkillFileSchema.extend({
  downloadUrl: z.url(),
...
export const SkillVersionWithDownloadsSchema = SkillVersionSchema.extend({
  files: z.array(SkillFileWithDownloadSchema),
});
