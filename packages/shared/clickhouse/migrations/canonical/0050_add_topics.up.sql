...
(
    ...
    transcript_id String DEFAULT 'poc',
    transcript_version LowCardinality(String) DEFAULT 'poc',
...
(
    ...
    topic_version_id String DEFAULT '',
    CONSTRAINT topic_identity_paired CHECK empty(topic_id) = empty(topic_version_id),
