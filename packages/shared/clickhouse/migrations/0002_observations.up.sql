CREATE TABLE observations (
    ...
    `provided_input_usage` Nullable(Decimal64(12)),
    `provided_output_usage` Nullable(Decimal64(12)),
    `provided_total_usage` Nullable(Decimal64(12)),
    `input_usage` Nullable(Decimal64(12)),
    `output_usage` Nullable(Decimal64(12)),
    `total_usage` Nullable(Decimal64(12)),
