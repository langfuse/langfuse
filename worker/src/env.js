...
const EnvSchema = zod_1.z.object({
    ...
    PORT: zod_1.z.coerce
        ...
        .default(3030),
    LANGFUSE_S3_BATCH_EXPORT_ENABLED: zod_1.z.enum(["true", "false"]).default("false"),
    ...
    BATCH_EXPORT_DOWNLOAD_LINK_EXPIRATION_HOURS: zod_1.z.coerce
        ...
        .positive()
        .default(24),
    BATCH_ACTION_EXPORT_ROW_LIMIT: zod_1.z.coerce.number().positive().default(50000),
    ...
    LANGFUSE_INGESTION_SECONDARY_QUEUE_PROCESSING_CONCURRENCY: zod_1.z.coerce
        ...
        .positive()
        .default(5),
    LANGFUSE_SECONDARY_INGESTION_QUEUE_ENABLED_PROJECT_IDS: zod_1.z.string().optional(),
    ...
    LANGFUSE_TRACE_UPSERT_WORKER_CONCURRENCY: zod_1.z.coerce
        ...
        .positive()
        .default(25),
    LANGFUSE_TRACE_DELETE_CONCURRENCY: zod_1.z.coerce.number().positive().default(1),
    LANGFUSE_SCORE_DELETE_CONCURRENCY: zod_1.z.coerce.number().positive().default(1),
    LANGFUSE_PROJECT_DELETE_CONCURRENCY: zod_1.z.coerce.number().positive().default(1),
    ...
    LANGFUSE_SKIP_INGESTION_CLICKHOUSE_READ_PROJECT_IDS: zod_1.z.string().default(""),
    ...
    LANGFUSE_SKIP_INGESTION_CLICKHOUSE_READ_MIN_PROJECT_CREATE_DATE: zod_1.z
        ...
        .optional(),
    // Otel
    OTEL_EXPORTER_OTLP_ENDPOINT: zod_1.z.string().default("http://localhost:4318"),
    ...
    QUEUE_CONSUMER_DATA_RETENTION_QUEUE_IS_ENABLED: zod_1.z
        .enum(["true", "false"])
        .default("true"),
    LANGFUSE_CACHE_MODEL_MATCH_ENABLED: zod_1.z.enum(["true", "false"]).default("true"),
    LANGFUSE_CACHE_MODEL_MATCH_TTL_SECONDS: zod_1.z.coerce.number().default(60 * 60),
...
exports.env = process.env.DOCKER_BUILD === "1"
    ? process.env
