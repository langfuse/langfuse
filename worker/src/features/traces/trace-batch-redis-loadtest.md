...
**120 is the initial cap; compare 1,000 later while keeping sampling and query
settings fixed.** No claim about ClickHouse's optimal cap follows from this test.
