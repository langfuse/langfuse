...
export const buildBlobExportDeprecationNotice = (): string =>
  [
    ...
    "==================",
    "",
    'This export uses the "Traces and observations (legacy)" data source, which',
    "is deprecated and will be removed in a future release.",
    "",
    'Please migrate this integration to the "Enriched observations (recommended)"',
    "export source. Enriched observations combine observations with their trace",
    "attributes in a single row and offer significantly better export",
    "performance. Scores are always included, regardless of the selected source.",
    "",
    "Migration guide:",
