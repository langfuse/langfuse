...
// An integration handler must treat a deterministic customer-config fault (a
// bad/malicious hostname rejected by validateWebhookURL) as the customer's
// problem — classify it, disable, and stay quiet — while transient/infra
// faults keep retrying and tripping the monitor. This module mirrors the
// blob-storage isCustomerFaultError exports:
...
describe("classifyCustomerFault / isCustomerFaultError", () => {
