...
// customer-config / credential fault. Feature handlers (blob storage, PostHog)
// use this to decide whether to auto-disable an integration instead of
// retrying/alerting forever. Each feature owns its own disable metric; only
// the classification is shared here.
//
...
// (StorageService.handleStorageError, or the PostHog hostname rethrow), so we
