  ...
  describe("isIPBlocked", () => {
    ...
    describe("IPv6 blocked addresses", () => {
      ...
      it("should block Teredo addresses", () => {
        ...
        expect(isIPBlocked("2001:0000:4136:e378:8000:63bf:3fff:fdd2", [])).toBe(
          true,
        );
      });
    });
    ...
    describe("whitelisted IPs", () => {
      it("should allow whitelisted IPv4 addresses that would normally be blocked", () => {
        ...
        expect(isIPBlocked("127.0.0.1", ["127.0.0.1", "192.168.1.100"])).toBe(
          false,
        );
        expect(
        ...
        expect(isIPBlocked("192.168.1.1", ["127.0.0.1", "192.168.1.100"])).toBe(
          true,
        );
        expect(isIPBlocked("10.0.0.1", ["127.0.0.1", "192.168.1.100"])).toBe(
          true,
        );
      });
