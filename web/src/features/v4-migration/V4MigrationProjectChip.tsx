...
export function V4MigrationProjectChip({
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="text-secondary ring-border hover:bg-muted/50 relative inline-flex shrink-0 items-center gap-1.5 rounded-full px-2 py-0.5 text-xs font-bold whitespace-nowrap ring"
    >
      <span
        aria-hidden
