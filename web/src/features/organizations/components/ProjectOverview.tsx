...
const DemoOrganizationTile = () => {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Try Weval Studio Demo</CardTitle>
      </CardHeader>
      <CardContent>
        We have built a Q&A chatbot that answers questions based on the Weval
        Studio Docs. Interact with it to see traces in Weval Studio.
      </CardContent>
      <CardFooter>
        <Button asChild variant="secondary">
      ...
      <CardContent>
        <CardDescription>
          {canCreateOrgs
            ...
            : "You need to get invited to an organization to get started with Weval Studio."}
        </CardDescription>
      </CardContent>
