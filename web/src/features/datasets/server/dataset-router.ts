    ...
    .query(async ({ input, ctx }) => {
      ...
      >(Prisma.sql`
        ...
        SELECT
          ...
          COALESCE(avg_total_cost."avgTotalCost", 0) "avgTotalCost",  
        ...
        FROM
          ...
          LEFT JOIN avg_total_cost_by_run_id avg_total_cost ON avg_total_cost.run_id = runs.id
