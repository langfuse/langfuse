...
vi.mock(
  "@/src/features/annotation-queues/components/session/ConnectedModernSessionBodyLegacy",
  () => ({
...
vi.mock(
  "@/src/features/annotation-queues/components/session/ConnectedModernSessionBodyTimeline",
  () => ({
...
vi.mock(
  "@/src/features/annotation-queues/components/session/ModernSessionHeader",
  () => ({
...
vi.mock(
  "@/src/features/annotation-queues/components/session/ModernSessionFilterControls",
  () => ({
...
vi.mock(
  "@/src/features/annotation-queues/components/session/SessionMetadataJsonPathControl",
  () => ({
