...
import { JudgeModelPicker } from "@/src/features/evals/v2/components/production/JudgeModelPicker/JudgeModelPicker";
...
export const Code = meta.story({
  args: { value: "code", onValueChange: fn() },
  render: StatefulEvaluatorModeSelector,
});
...
export const WithJudgeModel = meta.story({
  render: function Render() {
    const [evaluatorType, setEvaluatorType] = useState<EvaluatorMode>("llm");
