...
export const EVALUATOR_GALLERY_SAFETY_SECTION_KEY = "safety";
export const EVALUATOR_GALLERY_ALL_SECTION_KEY = "all";
export const EVALUATOR_GALLERY_EXPANDED_PROJECT_LIMIT = 100;
export const EVALUATOR_GALLERY_SAFETY_CALLOUT =
  "These evaluators run after the fact on completed traces. They are not real-time guardrails.";
