              ...
              >
                {question.options.map((option) => (
                  <Label
                    key={option}
                    htmlFor={option}
                    className="border-border hover:bg-muted/50 flex flex-1 cursor-pointer items-center gap-3 rounded-lg border p-3 text-sm font-medium leading-none transition-colors peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  >
