    ...
    return (
      ...
      >
        ...
        <CommandPrimitive.Input
          ref={ref}
          className={cn(
            "placeholder:muted-foreground outline-hidden flex h-8 w-full rounded-md border-transparent bg-transparent px-1 text-sm focus:border-0 focus:border-none focus:border-transparent focus:ring-0 disabled:cursor-not-allowed disabled:opacity-50",
            className,
          )}
          autoFocus
          {...props}
