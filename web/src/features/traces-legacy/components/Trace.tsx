...
import { TraceDataProvider } from "@/src/features/traces-legacy/contexts/TraceDataContext";
import {
  ViewPreferencesProvider,
  useViewPreferences,
} from "@/src/features/traces-legacy/contexts/ViewPreferencesContext";
import {
  SelectionProvider,
  useSelection,
} from "@/src/features/traces-legacy/contexts/SelectionContext";
import { useSelectedObservation } from "@/src/features/traces-legacy/hooks/useSelectedObservation";
import { SearchProvider } from "@/src/features/traces-legacy/contexts/SearchContext";
import { JsonExpansionProvider } from "@/src/features/traces-legacy/contexts/JsonExpansionContext";
import { PlayheadProvider } from "@/src/features/traces-legacy/contexts/PlayheadContext";
import {
  TraceGraphDataProvider,
  useTraceGraphData,
} from "@/src/features/traces-legacy/contexts/TraceGraphDataContext";
import { TraceLayoutMobile } from "@/src/features/traces-legacy/components/TraceLayoutMobile";
import { TraceLayoutDesktop } from "@/src/features/traces-legacy/components/TraceLayoutDesktop";
import { TracePanelNavigation } from "@/src/features/traces-legacy/components/TracePanelNavigation";
import { TracePanelDetail } from "@/src/features/traces-legacy/components/TracePanelDetail";
import { TracePanelNavigationLayoutDesktop } from "@/src/features/traces-legacy/components/TracePanelNavigationLayoutDesktop/TracePanelNavigationLayoutDesktop";
import { TraceTree } from "@/src/features/traces-legacy/components/TraceTree";
import { TraceTimelineCompact } from "@/src/features/traces-legacy/components/TraceTimelineDense/TraceTimelineCompact";
import { useIsMobile } from "@/src/hooks/use-mobile";
import { useTraceComments } from "@/src/features/traces-legacy/hooks/useTraceComments";
import { TraceGraphView } from "@/src/features/traces-legacy/components/TraceGraphView/TraceGraphView";
