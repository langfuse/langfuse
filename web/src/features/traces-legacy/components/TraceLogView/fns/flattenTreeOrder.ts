import type { TreeNode } from "@/src/features/traces-legacy/types/treeNode";
import type { FlatLogItem } from "@/src/features/traces-legacy/components/TraceLogView/log-view-types";
