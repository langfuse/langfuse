...
import type { IOPreviewContentMode } from "@/src/features/traces-legacy/components/IOPreview/IOPreview";
 ...
 */
function shouldRenderMessage(message: ChatMlMessage): boolean {
  return (
