...
type CategoricalTextFilter = Extract<
  FilterState[number],
  { type: "string" }
> & {
  operator: TextFilterOperator;
...
): filter is CategoricalTextFilter {
...
export function useSidebarFilterState(
  ...
  const { loading, implicitDefaultConfig, onExplicitFilterStateChange } =
    hookOptions;
