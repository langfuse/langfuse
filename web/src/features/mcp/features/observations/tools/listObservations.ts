...
export const [listObservationsTool, handleListObservations] = defineTool({
  ...
  description: [
    ...
    "For metadata filters, first call getObservationFilterValues with observationIds, traceId, or a bounded time range, then set the relevant key field in the filter.",
    "",
