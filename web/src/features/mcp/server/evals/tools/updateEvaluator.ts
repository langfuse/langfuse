...
export const [updateEvaluatorTool, handleUpdateEvaluator] = defineTool({
  ...
  description: [
    ...
    "Set type to `LLM_AS_JUDGE` and provide either prompt or structured promptMessages, plus outputDefinition. Prefer promptMessages when preserving message roles. Omit modelConfig to use the project default, or provide modelConfig with provider, model, and optional modelParams. For `CODE`, provide sourceCode + sourceCodeLanguage.",
  ].join(" "),
