// PROTOTYPE — throwaway. Variant E: role picker only (no permissions view), with a New role option.
...
export const variantEMeta = { key: "E", name: "Role picker + New role" };
      ...
      <Card className="w-full max-w-[33.05rem] shadow-2xl">
        ...
        <CardContent className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              value={creatingRole ? NEW_ROLE : draft.preset}
              ...
              <SelectContent>
                ...
                >
                  <div className="flex items-start gap-2 text-left">
                    ...
                    <div className="flex flex-col">
                      <span className="font-bold">New role</span>
                      <span className="text-muted-foreground text-xs">
