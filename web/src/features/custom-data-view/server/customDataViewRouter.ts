...
- \`data\` is the observation object. Its exact shape (long values truncated) is shown in the user message. Any field can be null, missing, or a string where you'd expect an object — code defensively (optional chaining, Array.isArray checks, try/catch around JSON.parse of stringified JSON).
