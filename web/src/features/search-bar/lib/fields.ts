...
export const FIELDS: FieldDef[] = [
  ...
  { id: "hasInputOutput", aliases: ["hasinputoutput", "has_input_output", "hasio", "withio"], kind: "boolean", syncMode: "textSearch", description: "Whether the observation has input or output" },
