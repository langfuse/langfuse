...
const OVERVIEW_CARD_IDS = {
  ...
  modelCosts: "overview:model-costs",
  scoresTable: "overview:scores-table",
  tracesTimeSeries: "overview:traces-time-series",
  modelUsage: "overview:model-usage",
  users: "overview:users",
  chartScores: "overview:chart-scores",
  latencyTables: "overview:latency-tables",
  generationLatency: "overview:generation-latency",
  scoreAnalytics: "overview:score-analytics",
} as const;
...
export default function ProjectOverviewPage() {
  ...
  const overviewSchedulerIdPrefix = `${projectId}:`;
              ...
              {uiCustomization?.feedbackHref === undefined && (
                ...
                >
                  <Button
                    id="date"
                    variant="outline"
                    className="text-primary hover:bg-primary-foreground hover:text-primary-accent group justify-start gap-x-3 text-left font-semibold"
                  >
                    <BarChart2
        ...
        {!isDashboardDataReady ? (
          ...
          <div className="grid w-full grid-cols-1 gap-3 overflow-hidden lg:grid-cols-2 xl:grid-cols-6">
            <TracesBarListChart
              ...
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.traces}`}
            />
            <ModelCostTable
              className="col-span-1 xl:col-span-2"
              projectId={projectId}
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.modelCosts}`}
            />
            <ScoresTable
              className="col-span-1 xl:col-span-2"
              projectId={projectId}
            ...
            <TracesAndObservationsTimeSeriesChart
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.tracesTimeSeries}`}
            />
            <ModelUsageChart
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.modelUsage}`}
            />
            <UserChart
              className="col-span-1 xl:col-span-3"
              projectId={projectId}
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.users}`}
            />
            <ChartScores
              className="col-span-1 xl:col-span-3"
              agg={agg}
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.chartScores}`}
            />
            <LatencyTables
              projectId={projectId}
              globalFilterState={[...userFilterState, ...environmentFilter]}
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.latencyTables}`}
            />
            <GenerationLatencyChart
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.generationLatency}`}
            />
            <ScoreAnalytics
              className="col-span-1 flex-auto justify-between lg:col-span-full"
              agg={agg}
              ...
              isLoading={environmentOptionsState.isPending}
              metricsVersion={metricsVersion}
              schedulerId={`${overviewSchedulerIdPrefix}${OVERVIEW_CARD_IDS.scoreAnalytics}`}
            />
          </div>
        )}
      </Page>
