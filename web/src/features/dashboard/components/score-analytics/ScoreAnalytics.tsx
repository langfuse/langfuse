...
export function ScoreAnalytics(props: {
  ...
  return (
    <DashboardCard
      ...
      title={t("scoresAnalytics")}
      description={t("scoresAnalyticsDescription")}
