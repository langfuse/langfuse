...
export default function ExperimentItemsTable({
  ...
  const columns: LangfuseColumnDef<ExperimentItemsTableRow>[] = [
    ...
    }),
    {
      ...
      id: "observationId",
      header: () =>
        renderExperimentSpecificHeader(tExperiments("table.observationId")),
      size: 180,
      enableHiding: true,
      cell: ({ row }) => {
        const experiments = row.original.experiments;
    ...
    },
    {
      ...
      id: "startTime",
      header: () =>
        renderExperimentSpecificHeader(tExperiments("table.startTime")),
      size: 180,
      defaultHidden: true,
      enableHiding: true,
      enableSorting: true,
    ...
    },
    {
      accessorKey: "level",
      id: "level",
      header: () => renderExperimentSpecificHeader(tExperiments("table.level")),
      size: 120,
      defaultHidden: true,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      id: "totalCost",
      header: () =>
        renderExperimentSpecificHeader(tExperiments("table.totalCost")),
      size: 120,
      enableHiding: true,
      cell: ({ row }) => {
        const experiments = row.original.experiments;
    ...
    },
    {
      ...
      id: "latencyMs",
      header: () =>
        renderExperimentSpecificHeader(tExperiments("table.latency")),
      size: 120,
      enableHiding: true,
      cell: ({ row }) => {
        const experiments = row.original.experiments;
    ...
    },
    {
      ...
      id: "experimentId",
      header: () =>
        renderExperimentSpecificHeader(tExperiments("table.experiment")),
      size: 150,
      defaultHidden: true,
      enableHiding: true,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: tExperiments("table.observationScores"),
    ...
    },
    {
      ...
      header: tExperiments("table.traceScores"),
      id: "traceScores",
      enableHiding: true,
      defaultHidden: true,
      cell: () => {
