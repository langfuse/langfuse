...
const sidebarShortcutBadgeClassName =
  "border-black/[0.07] bg-black/[0.04] text-black/[0.46] opacity-0 shadow-none transition-opacity duration-150 ease-out group-focus-within/sidebar-item:opacity-100 group-hover/sidebar-item:opacity-100 group-focus-visible/sidebar-item:opacity-100";
