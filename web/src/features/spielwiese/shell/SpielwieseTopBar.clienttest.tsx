...
describe("SpielwieseTopBar", () => {
  it("uses the page-nav secondary action chrome", () => {
    ...
    expect(shareButton.className).toContain("bg-background");
    ...
    expect(docsLink.className).toContain("bg-background");
    ...
    expect(notificationsButton.className).toContain("border");
    expect(notificationsButton.className).toContain("bg-background");
