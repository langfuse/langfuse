...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_LANGFUSE_FULL_TEXT_SEARCH_MAX_QUERY_LENGTH: z.coerce
      .number()
      .gte(1)
      .default(1_000_000),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_LANGFUSE_FULL_TEXT_SEARCH_MAX_QUERY_LENGTH:
      process.env.NEXT_PUBLIC_LANGFUSE_FULL_TEXT_SEARCH_MAX_QUERY_LENGTH,
