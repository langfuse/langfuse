...
export const env = createEnv({
  ...
  server: {
    ...
    LANGFUSE_DISABLE_EXPENSIVE_DASHBOARD_COMPONENTS: z.enum(["true", "false"]).optional().default("false"),
    SALT: z.string({
      required_error:
  ...
  runtimeEnv: {
    ...
    LANGFUSE_DISABLE_EXPENSIVE_DASHBOARD_COMPONENTS:
      process.env.LANGFUSE_DISABLE_EXPENSIVE_DASHBOARD_COMPONENTS,
