...
export const env = createEnv({
  ...
  server: {
    ...
    LANGFUSE_IN_APP_AGENT_MAX_ACTIVE_RUNS_PER_ORG: z.coerce
      ...
      .positive()
      .default(20),
    LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_UPSTREAM_ORIGIN: z
      .string()
      .url()
      .optional(),
    LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_PROJECT_PUBLIC_KEY: z.string().optional(),
    LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_PROJECT_SECRET_KEY: z.string().optional(),
  },
  ...
  runtimeEnv: {
    ...
    LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_UPSTREAM_ORIGIN:
      process.env.LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_UPSTREAM_ORIGIN,
    LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_PROJECT_PUBLIC_KEY:
      process.env.LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_PROJECT_PUBLIC_KEY,
    LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_PROJECT_SECRET_KEY:
      process.env.LANGFUSE_IN_APP_AGENT_SDK_GATEWAY_PROJECT_SECRET_KEY,
