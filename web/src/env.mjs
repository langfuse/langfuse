...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    AUTH_BROWSERSTACK_CLIENT_ID: process.env.AUTH_BROWSERSTACK_CLIENT_ID,
    AUTH_BROWSERSTACK_CLIENT_SECRET:
      process.env.AUTH_BROWSERSTACK_CLIENT_SECRET,
    AUTH_BROWSERSTACK_ISSUER: process.env.AUTH_BROWSERSTACK_ISSUER,
    AUTH_BROWSERSTACK_ALLOW_ACCOUNT_LINKING:
      process.env.AUTH_BROWSERSTACK_ALLOW_ACCOUNT_LINKING,
    AUTH_BROWSERSTACK_CLIENT_AUTH_METHOD:
      process.env.AUTH_BROWSERSTACK_CLIENT_AUTH_METHOD,
    AUTH_BROWSERSTACK_CHECKS: process.env.AUTH_BROWSERSTACK_CHECKS,
    AUTH_BROWSERSTACK_SCOPE: process.env.AUTH_BROWSERSTACK_SCOPE,
    // Email
