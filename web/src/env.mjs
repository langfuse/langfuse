...
export const env = createEnv({
  ...
  server: {
    ...
    AUTH_CLICKHOUSE_CLOUD_ALLOW_ACCOUNT_LINKING: z.enum(["true", "false"]).optional(),
  ...
  runtimeEnv: {
    ...
    AUTH_CLICKHOUSE_CLOUD_CLIENT_ID: process.env.AUTH_CLICKHOUSE_CLOUD_CLIENT_ID,
    AUTH_CLICKHOUSE_CLOUD_CLIENT_SECRET: process.env.AUTH_CLICKHOUSE_CLOUD_CLIENT_SECRET,
    AUTH_CLICKHOUSE_CLOUD_ISSUER: process.env.AUTH_CLICKHOUSE_CLOUD_ISSUER,
    AUTH_CLICKHOUSE_CLOUD_ALLOW_ACCOUNT_LINKING: process.env.AUTH_CLICKHOUSE_CLOUD_ALLOW_ACCOUNT_LINKING,
    AUTH_CLICKHOUSE_CLOUD_CLIENT_AUTH_METHOD: process.env.AUTH_CLICKHOUSE_CLOUD_CLIENT_AUTH_METHOD,
