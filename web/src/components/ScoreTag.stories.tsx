...
// All four levels as tags. Flip the toolbar theme to check the dark-mode tokens.
export const VariantMatrix = meta.story({
  args: {
    level: "trace",
  },
  render: () => (
    <div className="grid w-fit grid-cols-[auto_auto] items-center gap-x-6 gap-y-2 text-sm">
...
// The tag next to real score chips in list and option rows.
