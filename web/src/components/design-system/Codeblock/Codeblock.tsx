...
const CodeBlock: FC<Props> = memo(({ language, value, theme }) => {
  ...
  return (
    <div className="codeblock bg-code relative w-full overflow-hidden rounded border font-sans">
      <div className="bg-code-header flex w-full items-center justify-between px-2">
