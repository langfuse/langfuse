  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div className="relative">
        ...
        >
          {showPassword ? (
            <EyeOff className="text-tertiary h-5 w-5" />
          ) : (
            <Eye className="text-tertiary h-5 w-5" />
          )}
        </button>
      </div>
    );
