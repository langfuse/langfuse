      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-[calc(100svh-var(--banner-height,0px))] w-full text-sidebar-foreground has-[[data-variant=inset]]:bg-sidebar",
              className,
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative h-[calc(100svh-var(--banner-height,0px))] w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear",
        ...
        <div
          className={cn(
            "fixed bottom-0 top-[var(--banner-height,0px)] z-20 hidden h-[calc(100svh-var(--banner-height,0px))] w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
        ...
        >
          <div
            ...
            className={cn([
              ...
              "h-[calc(100svh-var(--banner-height,0px))]", // offset if the notification banner is visible
            ])}
          >
            {children}
          </div>
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-[calc(100svh-var(--banner-height,0px))] flex-1 flex-col bg-background",
