          ...
          <PopoverTrigger asChild>
            ...
            >
              ...
              {group.items.length > 1 && (
                <span className="bg-primary text-primary-foreground absolute -right-1 -top-1 flex h-3.5 w-3.5 items-center justify-center rounded-full text-[9px] font-medium">
                  {group.items.length}
                </span>
              )}
            </button>
