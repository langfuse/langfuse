...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      "text-secondary **:[[cmdk-group-heading]]:text-tertiary **:[[cmdk-group-heading]]:font-regular overflow-hidden p-1 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-xs",
      className,
    )}
    {...props}
  />
