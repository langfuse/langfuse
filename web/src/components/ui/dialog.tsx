      ...
      <DialogPortal>
        ...
        >
          ...
          <div className="[&:has(.dialog-header)]:hidden [&:not(:has(.dialog-header))]:absolute [&:not(:has(.dialog-header))]:top-3 [&:not(:has(.dialog-header))]:right-3 [&:not(:has(.dialog-header))]:z-20">
            <DialogPrimitive.Close className="ring-offset-background focus:ring-focus data-[state=open]:bg-hover data-[state=open]:text-tertiary rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
              <X className="h-4 w-4" />
...
const DialogHeader = ({
  ...
  >
    <div className="flex w-full items-center justify-between gap-4 text-center sm:text-left">
      ...
      <DialogPrimitive.Close
        className="ring-offset-background focus:ring-focus data-[state=open]:bg-hover data-[state=open]:text-tertiary z-20 mt-1 ml-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
        tabIndex={-1}
      >
        <X className="h-4 w-4" />
        <span className="sr-only">Close</span>
