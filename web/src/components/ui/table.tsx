...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "bg-muted/50 font-emphasis border-t last:[&>tr]:border-b-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "bg-background text-muted-foreground font-emphasis relative h-10 border-b px-2 text-left align-middle [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
