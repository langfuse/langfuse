    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mb-6">
          A comprehensive set of UI components built with Radix UI and Tailwind CSS.
        </p>
      </div>
        ...
        <TabsContent value="inputs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Input fields and selection components</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="controls" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Switches, checkboxes, and toggles</CardDescription>
            </CardHeader>
