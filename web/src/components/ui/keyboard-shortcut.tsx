  ...
  ({ className, children, keys, ...props }, ref) => (
    <kbd
      ...
      className={cn(
        ...
        "bg-muted text-tertiary pointer-events-none hidden h-5 min-w-5 items-center justify-center gap-1 rounded-md border px-1.5 font-mono text-[10px] leading-none font-bold shadow-xs select-none md:inline-flex",
        className,
      )}
      {...props}
    >
