      ...
      >
        {tabs.map((tab) => {
          const tabClassName = cn(
            "hover:bg-muted/50 focus-visible:ring-focus text-tertiary inline-flex h-full items-center justify-center rounded-none border-b-2 border-transparent px-2 py-0.5 text-sm whitespace-nowrap transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden",
            tab.value === activeTab
              ? "border-brand text-primary bg-transparent shadow-none"
              : "",
