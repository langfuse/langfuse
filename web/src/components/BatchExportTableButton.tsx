  ...
  const getWarningMessage = () => {
    switch (props.tableName) {
      case BatchTableNames.Traces:
        return "Note: Filters on observation-level columns (Level, Tokens, Cost, Latency) are not included in trace exports. You may receive more data than expected. This issue will be addressed together with a comprehensive data model update in the future.";
      case BatchTableNames.Observations:
        return "Note: Filters on trace-level columns (Trace Name, Trace Tags, User ID, Trace Environment) are not included in observation exports. You may receive more data than expected. This issue will be addressed together with a comprehensive data model update in the future.";
