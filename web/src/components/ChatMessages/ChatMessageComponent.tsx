    ...
    >
      <div className="flex flex-row justify-center">
        ...
        <CardContent className="flex flex-1 flex-row items-center gap-2 p-0 pl-1">
          <div className="bg-canvas sticky top-0 bottom-0 z-10 flex w-16 shrink-0 flex-col gap-1">
            {isPlaceholder ? (
              <span className="bg-hover text-tertiary inline-flex h-6 w-full items-center justify-center rounded-md px-4 font-mono text-[9px]">
                placeholder
              </span>
            ) : (
              <Button
                ...
                type="button"
                variant="ghost"
                className="text-tertiary hover:bg-hover hover:text-on-hover h-6 w-full px-1 py-0 text-[10px] font-bold"
              >
