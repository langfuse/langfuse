...
function DatasetCompareChartsLegacy() {
  ...
  return (
    <Page
      headerProps={{
        title: t("compareExperiments", {
          dataset: dataset.data?.name ?? datasetId,
        }),
        tabsProps: {
        ...
        help: {
          description: t("compareExperimentsHelp"),
        },
        actionButtonsRight: (
          <>
            <Dialog
        ...
        >
          ...
          <SidePanelContent className="overflow-y-auto p-1">
            <div className="w-full space-y-4">
              <div>
                <SubHeaderLabel title={t("descriptionLabel")} />
                <span className="text-muted-foreground text-sm">
                  {dataset.data?.description ?? t("noDescription")}
                </span>
              </div>
