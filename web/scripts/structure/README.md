...
| 14, 15 | design-system purity; git-mv moves                                                            | review / process — not counted. Rule 14's import boundary is also enforced by `@repo/no-design-system-external-components` |
