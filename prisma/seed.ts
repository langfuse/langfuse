...
async function main() {
  ...
  await prisma.model.upsert({
    where: { id: "43986a4d-29bc-46d8-8641-5874ddf68961" },
    create: {
      id: "43986a4d-29bc-46d8-8641-5874ddf68961",
      modelName: "gpt-4",
      inputPrice: "0.03",
      outputPrice: "0.06",
  ...
  await prisma.model.upsert({
    where: { id: "984de963-6124-4353-99f1-14da34a5bff8" },
    create: {
      id: "984de963-6124-4353-99f1-14da34a5bff8",
      modelName: "gpt-3.5-turbo",
      inputPrice: "0.0010",
      outputPrice: "0.0020",
  ...
  await prisma.model.upsert({
    where: { id: "30bec1ca-02a7-4785-8ac5-36c5474b1201" },
    create: {
      id: "30bec1ca-02a7-4785-8ac5-36c5474b1201",
      modelName: "gpt-3.5-turbo",
      inputPrice: "0.001",
      outputPrice: "0.002",
      matchPattern: "(?i)^(gpt-)(35|3.5)(-turbo)?$",
      ...
      startDate: new Date("2023-12-01"),
      tokenizerConfig: { tokenPerMessage: 3, tokensPerName: 1 },
      tokenizerId: "openai",
      totalPrice: null,
      unit: "TOKENS",
    },
