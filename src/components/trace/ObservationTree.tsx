...
export const ObservationTree = (props: {
  ...
  const [observationTreeNodeHidden, setObservationTreeNodeHidden] =
    useState(false);
  ...
  return (
    <div className="flex flex-col">
      <ObservationTreeTraceNode
        ...
        childHidden={observationTreeNodeHidden}
        setChildHidden={setObservationTreeNodeHidden}
      />
      {!observationTreeNodeHidden && (
        <ObservationTreeNode
...
const ObservationTreeTraceNode = (props: {
  ...
  setCurrentObservationId: (id: string | undefined) => void;
  childHidden: boolean;
  setChildHidden: (value: boolean) => void;
}) => (
  <div
    className={cn(
    ...
    <div className="flex gap-2">
      {props.childHidden ? (
        <PlusIcon
          ...
          onClick={() => props.setChildHidden(false)}
        />
      ) : (
        <MinusIcon
          className="border border-black"
          onClick={() => props.setChildHidden(true)}
        />
      )}
