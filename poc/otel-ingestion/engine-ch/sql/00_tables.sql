...
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_8 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_9 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_10 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_11 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_12 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_13 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_14 AS poc_chlb.events_poc;
CREATE TABLE IF NOT EXISTS poc_chlb.events_poc_staging_15 AS poc_chlb.events_poc;
