---
name: turborepo
description: Turborepo guidance for turbo.json, pipelines, dependsOn, cache, filters, affected builds, CI, env vars, monorepo packages, task graphs, and boundaries.
metadata:
