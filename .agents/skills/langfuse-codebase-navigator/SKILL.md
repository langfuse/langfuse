...
- Before any agent write to Linear — a comment, a description edit, a ticket: use `linear-agent-writes`, the write policy. Ordinary writes stay a title and a few sentences.
