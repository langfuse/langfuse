...
| Anthropic | claude-opus-4-5-20251101 | Input $5/MTok (5e-6), Output $25/MTok (25e-6), 5m $6.25/MTok, 1h $10/MTok, read $0.50/MTok | Yes | Not on flat list; no explicit Large Context pricing published | Not applicable | None | https://platform.claude.com/docs/en/about-claude/pricing | Listed as "Claude Opus 4.5" on pricing page. Not on flat long-context list. No large-context tier in file — consistent with no published tier pricing. |
...
| Google | gemini-2.0-flash | Input $0.10/MTok (1e-7), Output $0.40/MTok (4e-7) | No | Deprecated | Not applicable | None | https://ai.google.dev/pricing | Listed as deprecated on official page. Existing prices retained (audio price $0.70/MTok not tracked). |
| Google | gemini-2.0-flash-001 | Same as gemini-2.0-flash | No | Deprecated | Not applicable | None | https://ai.google.dev/pricing | Listed as deprecated. Existing prices retained. |
| Google | gemini-3.6-flash | Input $1.50/MTok (1.5e-6), Output $7.50/MTok (7.5e-6), Cache read $0.15/MTok (1.5e-7) | Yes | No large-context tier on official page | Yes | Added | https://ai.google.dev/pricing | New model confirmed on official AI Studio pricing page July 2026. Added to pricing file and selectable models. Output ($7.50) is lower than gemini-3.5-flash ($9.00) — this is correct. |
| Google | gemini-3.5-flash-lite | Input $0.30/MTok (3e-7), Output $2.50/MTok (2.5e-6), Cache read $0.03/MTok (3e-8) | Yes | No large-context tier | Yes | Added | https://ai.google.dev/pricing | New model confirmed on official AI Studio pricing page July 2026. Added to pricing file and selectable models. Cache = 10% of input. |

## Unresolved findings (updated 2026-07-22)
