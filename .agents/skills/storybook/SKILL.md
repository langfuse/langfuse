---
name: storybook
description: guidance for writing Storybook stories for components
---
...
- Name stories after the state they represent, not the implementation.
  - Prefer: `Default`, `Empty`, `WithLongName`, `Error`, `Disabled`, `Loading`
  - Avoid: `Test1`, `CustomRenderExample`
