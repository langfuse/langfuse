...
| Known-answer trace metric rollup shapes                                                                                                         | `pnpm run seed -- trace-metrics-shapes --v4` (seven traces covering cheap/expensive cost, a two-hour multi-bucket trace, duplicate span versions, root-zero/child-cost, in-flight spans, and a late expensive span)                                                                                                                   |
