...
| See which environments exist for the project and how many traces each has                | `pnpm run seed -- env` (add `--json` for machines; respects the same `--project` flag as `doctor`)                                                                                                                                       |
