...
class Trace {
    ...
    async create(request) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.LangfuseEnvironment.Local, "/api/public/traces"),
            method: "POST",
            headers: {
    ...
    async update(request) {
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            body: await serializers.UpdateTraceRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: 60000,
        });
        if (_response.ok) {
            return await serializers.Trace.parseOrThrow(_response.body, {
